  ...
  const products = [
    {
      ...
      color: "#ff8c42",
      image: pineappleProduct,
    },
    {
      name: "Fremont Mandarin",
      color: "#ffa500",
      image: fremontProduct,
    },
    {
      name: "Grapefruit",
      color: "#ff6b6b",
      image: grapefruitProduct,
    },
    {
    ...
    },
    {
      name: "Thomson Grapes",
      color: "#74c69d",
      image: thomsonProduct,
    },
    {
      name: "Medjool Dates",
      color: "#8b4513",
      image: medjoolProduct,
    },
    {
      name: "Barhi Dates",
      color: "#d4a574",
      ...
      <ScrollReveal>
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Modern agriculture rooted in Egypt and growing for international markets.
          </p>
        </div>
      </ScrollReveal>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-10 items-center">
        ...
        <ScrollReveal delay={0.15}>
          ...
          >
            ...
            <div className="absolute -bottom-24 -left-24 w-56 h-56 rounded-full bg-secondary/10 blur-3xl" />
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground leading-8 text-lg mb-8">
                Al Hanaa for Agricultural Development rooted in Egypt and growing for
                the world, Al Hanaa is a modern agricultural company focused on
                sustainable farming, premium quality, and international reach. Since
                2010, we've specialized in cultivating fresh fruits and processed
                products all managed through a fully integrated supply chain. Backed
                by the legacy of the El Morshedy Group, we combine innovation,
                expertise, and environmental responsibility to deliver excellence
                from soil to shelf.
              </p>
        ...
        <ScrollReveal delay={0.25}>
          <div className="relative">
            <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-br from-primary/10 to-secondary/10 blur-2xl" />
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <motion.div
                ...
                transition={{ duration: 0.25 }}
                className="sm:col-span-2 relative h-[360px] md:h-[420px] rounded-[2rem] overflow-hidden shadow-2xl border border-white/20"
              >
                <img
              ...
              {/* Small Images */}
              {aboutImages.slice(1, 3).map((item, index) => (
                <motion.div
                  key={item.title}
